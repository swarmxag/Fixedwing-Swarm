...
# Bind the socket to the port
graph_server_address = ('172.26.96.1', 12009)  #receive from .....rx.py
...
# Bind the socket to the port
server_address = ('172.26.96.1', 12005)  #receive from .....rx.py

# Bind the socket to the port
remove_bot_server_address = ('172.26.96.1', 12001)  #receive from .....rx.py
...
def vehicle_connection():	
	...
	try:	
		vehicle1= connect('udpin:172.26.96.1:14551',baud=115200, heartbeat_timeout=heartbeat_ip_timeout[0])
		print('Drone1')
	...
	try:		
		vehicle2= connect('udpin:172.26.96.1:14552',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[1])
		print('Drone2')
		num_bots+=1	
	...
	try:
		vehicle3= connect('udpin:172.26.96.1:14553',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[2])
		print('Drone3')
		num_bots+=1
	...
	try:		
		vehicle4= connect('udpin:172.26.96.1:14554',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[3])
		print('Drone4')
		num_bots+=1
	...
	try:		
		vehicle5= connect('udpin:172.26.96.1:14555',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[4])
		print('Drone5')
		num_bots+=1
	...
	try:
		vehicle6= connect('udpin:172.26.96.1:14556',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[5])
		print('Drone6')
		num_bots+=1
	...
	try:
		vehicle7= connect('udpin:172.26.96.1:14557',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[6])
		print('Drone7')
		num_bots+=1
	...
	try:
		vehicle8= connect('udpin:172.26.96.1:14558',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[7])
		print('Drone8')
		num_bots+=1
	...
	try:	
		vehicle9= connect('udpin:172.26.96.1:14559',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[8])
		print('Drone9')
		num_bots+=1
	...
	try:	
		vehicle10= connect('udpin:172.26.96.1:14560',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[9])
		print('Drone10')
		        ...
		        try:
			        ...
			        try:
			            ...
			            if int(sys_id) in port_dict:
			                connection_str = f"udpin:172.26.96.1:{port_dict[int(sys_id)]}"
