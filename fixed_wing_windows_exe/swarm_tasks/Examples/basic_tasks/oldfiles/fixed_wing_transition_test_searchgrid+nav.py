...
# Bind the socket to the port
graph_server_address = ('192.168.113.74', 12009)  #receive from .....rx.py
...
uav4_server_address = ('192.168.113.93', 12002)
#uav5 = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
#uav5_server_address = ('192.168.113.93', 12002)
...
# Bind the socket to the port
server_address = ('192.168.113.74', 12005)  #receive from .....rx.py

# Bind the socket to the port
remove_bot_server_address = ('192.168.113.74', 12001)  #receive from .....rx.py
...
vehicles=[]
pos_array=[]
heartbeat_ip=["192.168.6.151","192.168.6.152","192.168.6.153","192.168.113.93","192.168.6.155","192.168.6.156","192.168.6.157","192.168.6.158","192.168.6.159","192.168.6.160"]
...
def vehicle_connection():	
	...
	try:	
		vehicle1= connect('udpin:192.168.113.93:14551',baud=115200, heartbeat_timeout=heartbeat_ip_timeout[0])
	...
	try:		
		vehicle2= connect('udpin:192.168.113.93:14552',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[1])
	...
	try:
		vehicle3= connect('udpin:192.168.113.93:14553',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[2])
	...
	try:		
		vehicle4= connect('udpin:192.168.113.93:14554',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[3])
	...
	try:		
		vehicle5= connect('udpin:192.168.113.93:14555',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[4])
	...
	try:
		vehicle6= connect('udpin:192.168.113.93:14556',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[5])
	...
	try:
		vehicle7= connect('udpin:192.168.113.93:14557',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[6])
	...
	try:
		vehicle8= connect('udpin:192.168.113.93:14558',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[7])
	...
	try:	
		vehicle9= connect('udpin:192.168.113.93:14559',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[8])
	...
	try:	
		vehicle10= connect('udpin:192.168.113.93:14560',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[9])
...
slave_heal_ip=["192.168.113.93"]*num_bots
...
server_address1 = ('192.168.113.74', 12010)
slave_heal_ip=["192.168.113.93"]*num_bots
	...
	try:            
		...
		if(landing_flag) or data==b"return":
			...
			for b in s.swarm:				
				...
				dx_limit=50
				dy_limit=50
				t_uav_flag=[False}*len(pos_array)
				ind=[0]*num_bots
				#landing_flag=True
				while 1:					
					if(not landing_flag):
