...
if(file_name=="Medur_"):
	...
	start_multiple_goals=[(4027.8488645550074,3760.642457785382),
(4012.827259443787,4286.478720394705),
(4699.9337166909545,4225.707071204485),
(4565.51962560672,3662.2222298913643)]
	multiple_goals=start_multiple_goals
...
# Bind the socket to the port
remove_bot_server_address = ('192.168.6.210', 12001)  #receive from .....rx.py
...
def vehicle_connection():	
	...
	try:	
		vehicle1= connect('udpin:192.168.6.153:14551',baud=115200, heartbeat_timeout=heartbeat_ip_timeout[0])
	...
	try:		
		vehicle2= connect('udpin:192.168.6.153:14552',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[1])
	...
	try:
		vehicle3= connect('udpin:192.168.6.153:14553',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[2])
	...
	try:		
		vehicle4= connect('udpin:192.168.6.153:14554',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[3])
	...
	try:		
		vehicle5= connect('udpin:192.168.6.153:14555',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[4])
	...
	try:
		vehicle6= connect('udpin:192.168.6.153:14556',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[5])
	...
	try:
		vehicle7= connect('udpin:192.168.6.153:14557',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[6])
	...
	try:
		vehicle8= connect('udpin:192.168.6.153:14558',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[7])
	...
	try:	
		vehicle9= connect('udpin:192.168.6.153:14559',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[8])
	...
	try:	
		vehicle10= connect('udpin:192.168.6.153:14560',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[9])
...
while(1):
	...
	try:            
		...
		if(data.startswith(b"start")) or (circle_formation_flag) :
			...
			center_lat , center_lon = locatePosition.destination_location(float(base_lat),float(base_lon),700,0)
