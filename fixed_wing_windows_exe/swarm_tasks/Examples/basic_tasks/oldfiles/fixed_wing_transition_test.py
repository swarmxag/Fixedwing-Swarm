...
# Bind the socket to the port
graph_server_address = ('192.168.1.105', 12009)  #receive from .....rx.py
...
uav4_server_address = ('192.168.1.103', 12002)
#uav5 = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
#uav5_server_address = ('192.168.1.103', 12002)
...
if(file_name=="Medur_"):
	...
	start_multiple_goals=[(4225.5128163765585,2986.100255505548),
(3979.60523642999,2643.602967905786),
(3587.5802265870293,2734.1606300801363),
(3819.5409708283164,3124.2560304971357)]
...
# Bind the socket to the port
server_address = ('192.168.1.105', 12005)  #receive from .....rx.py

# Bind the socket to the port
remove_bot_server_address = ('192.168.1.105', 12001)  #receive from .....rx.py
...
vehicles=[]
pos_array=[]
heartbeat_ip=["192.168.6.151","192.168.6.152","192.168.6.153","192.168.1.103","192.168.6.155","192.168.6.156","192.168.6.157","192.168.6.158","192.168.6.159","192.168.6.160"]
...
def vehicle_connection():	
	...
	try:	
		vehicle1= connect('udpin:192.168.1.103:14551',baud=115200, heartbeat_timeout=heartbeat_ip_timeout[0])
	...
	try:		
		vehicle2= connect('udpin:192.168.1.103:14552',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[1])
	...
	try:
		vehicle3= connect('udpin:192.168.1.103:14553',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[2])
	...
	try:		
		vehicle4= connect('udpin:192.168.1.103:14554',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[3])
	...
	try:		
		vehicle5= connect('udpin:192.168.1.103:14555',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[4])
	...
	try:
		vehicle6= connect('udpin:192.168.1.103:14556',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[5])
	...
	try:
		vehicle7= connect('udpin:192.168.1.103:14557',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[6])
	...
	try:
		vehicle8= connect('udpin:192.168.1.103:14558',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[7])
	...
	try:	
		vehicle9= connect('udpin:192.168.1.103:14559',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[8])
	...
	try:	
		vehicle10= connect('udpin:192.168.1.103:14560',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[9])
...
slave_heal_ip=["192.168.1.103"]*num_bots
...
server_address1 = ('192.168.1.103', 12010)
slave_heal_ip=["192.168.1.103"]*num_bots
