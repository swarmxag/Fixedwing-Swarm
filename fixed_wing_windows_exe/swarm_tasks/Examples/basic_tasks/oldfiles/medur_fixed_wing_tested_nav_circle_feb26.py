...
# Bind the socket to the port
graph_server_address = ('192.168.6.130', 12009)  #receive from .....rx.py
...
uav1_server_address = ('192.168.6.130', 12002)  #receive from .....rx.py
uav2 = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
uav2_server_address = ('192.168.6.130', 12002)  #receive from .....rx.py
uav3 = socket.socket(socket.AF_INET, socket.SOCK_DGRAM)
uav3_server_address = ('192.168.6.130', 12002)
...
# Bind the socket to the port
server_address = ('192.168.6.130', 12005)  #receive from .....rx.py

# Bind the socket to the port
remove_bot_server_address = ('192.168.6.130', 12001)  #receive from .....rx.py
...
def vehicle_connection():	
	...
	try:	
		vehicle1= connect('udpin:192.168.6.130:14561',baud=115200, heartbeat_timeout=heartbeat_ip_timeout[0])
	...
	try:		
		vehicle2= connect('udpin:192.168.6.130:14562',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[1])
	...
	try:
		vehicle3= connect('udpin:192.168.6.130:14563',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[2])
	...
	try:		
		vehicle4= connect('udpin:192.168.6.130:14564',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[3])
	...
	try:		
		vehicle5= connect('udpin:192.168.6.130:14565',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[4])
	...
	'''
	try:
		vehicle6= connect('udpin:192.168.6.130:14566',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[5])
	...
	try:
		vehicle7= connect('udpin:192.168.6.130:14567',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[6])
	...
	try:
		vehicle8= connect('udpin:192.168.6.130:14568',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[7])
	...
	try:	
		vehicle9= connect('udpin:192.168.6.130:14569',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[8])
	...
	try:	
		vehicle10= connect('udpin:192.168.6.130:14570',baud=115200,heartbeat_timeout=heartbeat_ip_timeout[9])
