...
export const getAutomateGoals = (state) => state.socket.automateGoals;

export const getAutomateBearing = (state) => state.socket.automateBearing;

export const getAutomateSafetyMargin = (state) =>
  state.socket.automateSafetyMargin;
