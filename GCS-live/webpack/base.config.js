...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      'aframe/src/index': path.resolve(projectRoot, 'node_modules', 'aframe', 'src', 'index.js'),
      'aframe/dist/aframe-master': path.resolve(projectRoot, 'node_modules', 'aframe', 'src', 'index.js'),
      'aframe/dist/aframe-master.js': path.resolve(projectRoot, 'node_modules', 'aframe', 'src', 'index.js'),
      aframe: path.resolve(projectRoot, 'node_modules', 'aframe', 'src', 'index.js'),
      'react-virtuoso': path.resolve(projectRoot, 'node_modules', 'react-virtuoso', 'dist', 'index.cjs'),
